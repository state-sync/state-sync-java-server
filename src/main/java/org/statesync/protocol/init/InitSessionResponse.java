...
public class InitSessionResponse extends EventMessage {
	...
	public java.lang.String toString() {
		return "InitSessionResponse(sessionToken=" + this.getSessionToken() + ", protocolVersion=" + this.getProtocolVersion() + ")";
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (this$protocolVersion == null ? other$protocolVersion != null : !this$protocolVersion.equals(other$protocolVersion)) return false;
		return true;
	}
