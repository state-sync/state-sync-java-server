...
public class SubscribeAreaResponse extends ResponseMessage {
	...
	public SubscribeAreaResponse(final int forId, final String area, final ClientAreaConfig config, final ObjectNode model) {
	...
	public java.lang.String toString() {
		return "SubscribeAreaResponse(area=" + this.getArea() + ", config=" + this.getConfig() + ", model=" + this.getModel() + ")";
	}
